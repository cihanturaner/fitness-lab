...
import { BENCH, INCLINE, TARGET, fakeApi } from '@/test/fakeApi'
  ...
  workouts: [
    {
      ...
      shortened: true,
      exercises: [
        { exercise: BENCH, planned_exercise: null, sets: [set('a', 'bench', '44', 3, null)] },
        { exercise: INCLINE, planned_exercise: BENCH, sets: [set('b', 'incline', '11', 11, 2)] },
      ],
    },
  ],
  bodyweight_kg: '72',
...
describe('DayHistory', () => {
  ...
  it('shows one card per date, newest first, holding only what was recorded that day', async () => {
    ...
    // A changed exercise shows what was planned beside what was performed.
    expect(exercises[1]).toHaveTextContent('Incline Smith Press')
